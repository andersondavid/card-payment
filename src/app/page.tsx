    ...
    <main className="min-h-screen flex justify-center items-center">
      <div>
        <div className="py-4 px-8">
          <h1 className="font-lexend-mega font-bold text-2xl">
            Adicione um método de pagamento
          </h1>
        </div>
        <div className="bg-nb-clear rounded-2xl p-8 pt-4 flex border-4 relative before:border-4 before:absolute before:-z-10 before:top-2 before:left-0 before:bg-nb-dark-blue before:w-full before:h-full before:rounded-2xl">
          <div>
            <div className="w-80">
              <TextInput
                id="card-number"
